    ...
    with conn.cursor() as cur:
        ...
        for row in cur.fetchall():
            ...
            result[variant] = {
                ...
                "avg_margin_before_incentive": float(avg_margin or 0),
            }
    return result
...
def two_proportion_z_test(
    ...
    pooled = (treatment_success + control_success) / (treatment_total + control_total)

    pooled_se = math.sqrt(pooled * (1 - pooled) * (1 / treatment_total + 1 / control_total))
...
def main() -> None:
    ...
    payback_pct = observed_control_margin / break_even_value * 100 if break_even_value > 0 else 0
